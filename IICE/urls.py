...
urlpatterns = [
    ...
    path('Admin-PDFNameComparison/', adminViews.PDFNameComparison, name='PDFNameComparison'),
    path('export-pdf-comparison-results/', adminViews.export_pdf_comparison_results, name='export_pdf_comparison_results'),
